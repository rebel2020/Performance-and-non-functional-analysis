...
const getMessage = search => {
  ...
  const pagetxt = <span className="yellowtext">{page ? formatString(pagesMap[page]) : ''}</span>;
  ...
  if (!page && !brand && !phase) {
    ...
    message = (
      <div>
        {`The Average Metric Scores of All the Pages in `}
        {phasetxt}
        {` Environment on `}
        {datetxt}
        {` .`}
    ...
    message = (
      <div>
        {`The Average Metric Scores of All the Pages of `}
        {brandtxt}
        {` Brand in All Environments on `}
        {datetxt}
        {` .`}
      </div>
    );
    ...
    message = (
      <div>
        {`The Average Metric Scores of `}
        {pagetxt}
        {` in All Environments on `}
        {datetxt}
        {` .`}
      </div>
    );
